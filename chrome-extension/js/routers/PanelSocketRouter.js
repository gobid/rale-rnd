/*
- on connect - establish socket connection
- on user:id - save the user id
- on jsbin:listen - add the heardID (does some locking - some semaphore thing?)
- setBinId
- emit - objects to bins
- onSocketData - binding an event string to a callback
- getInstance - creates a new instance if needed
*/
