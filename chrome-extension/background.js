...
A) webpage => extension => instrumentation server => redrawn page
B) redrawn page => extension => server (port) => frontend of isopleth tab
- this script deals with B

- modify csp headers so we can get the info
*/
