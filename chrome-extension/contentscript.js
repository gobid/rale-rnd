/*
 ...
 - goes from webpage events to messages to the chrome extension about the state of the page changing
 - contentscripts run in the webspage and not the chrome extension, and they pass messages to the chrome extension 
 */
